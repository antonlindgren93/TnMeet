...
// export default class GiftedFormComponent extends React.Component {
//     render() {

export default function GiftedFormComponent() {

    
    console.log(GiftedForm)
    console.log(GiftedFormManager)
    ...
    //          response = firebase.database().ref('/users/' + userId).on('value', (snapshot) => {
